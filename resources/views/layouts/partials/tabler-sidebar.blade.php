<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark bg-dark" id="sidebar-menu">
    <div class="container-fluid">
        ...
        <!-- Logo + Botão da Setinha para Desktop -->
        <div class="d-flex align-items-center justify-content-between w-100 pe-lg-2">
            <h1 class="navbar-brand navbar-brand-autodark mb-0">
                <a href="{{ route('dashboard') }}" class="text-decoration-none">
                    <span class="ms-1 font-weight-bold brand-text">Sistema BI</span>
                </a>
            </h1>

            <!-- Botão com a Setinha para Encolher/Expandir -->
            <button type="button" id="toggle-sidebar" class="btn btn-icon btn-ghost-light btn-sm d-none d-lg-flex rounded-circle" title="Encolher/Expandir Menu">
            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                @can('usuarios.visualizar')
                    <li class="nav-item {{ request()->routeIs('users.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('users.index') }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Usuários">
                            <span class="nav-link-icon d-inline-block">
                ...
                @can('perfis.visualizar')
                    <li class="nav-item {{ request()->routeIs('roles.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('roles.index') }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Perfis (Roles)">
                            <span class="nav-link-icon d-inline-block">
                ...
                @can('permissoes.visualizar')
                    <li class="nav-item {{ request()->routeIs('permissions.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('permissions.index') }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Permissões">
                            <span class="nav-link-icon d-inline-block">
